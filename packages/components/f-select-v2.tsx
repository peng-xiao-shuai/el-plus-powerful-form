...
export const FSelectV2 = defineComponent({
  name: 'FSelectV2',
  props: componentProps(),
  setup(props) {
    const data = computed(
      () => props.formItem.data as SetDataType<FormTypeEnum.SelectV2>
    )

    const { event } = useEvent<FormTypeEnum.SelectV2>({
